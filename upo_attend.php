...
<table width="1113px" align="center">
 ...
 <td  height="33" colspan="2">Date From 
   ...
   To
      ...
      <input name="submit" type="button" value="Show Report" onClick="showupo();" /></td>
 ...
 <tr>
   ...
   <input type="hidden" name="upoid" value="<?php echo $upoid; ?>"></td>
 </tr>
 <tr>
...
<td width="900" valign="top"><div id="upoid" align="left" style="width:900px"></div></td>
</tr>
	</table>	
</form>
</body>
