...
<table  bgcolor="#EEF5FD" align="center">
...
<table width="1113px" align="center">
 ...
 <td  height="33" colspan="2">Date From 
   ...
   To
      ...
      <input name="submit" type="button" value="Show Report" onClick="showdistrict();" /></td>
 ...
 <tr>
   ...
   <input type="hidden" name="disid" value="<?php echo $disid; ?>"></td>
 </tr>
 <tr>
   <td width="300"><div id="main" align="left" style="width:300px; background-color:#EEF5FD">
...
<td width="900" valign="top"><div id="disid" align="left" style="width:900px"></div></td>
</tr>
	</table>	
</form>
</body>
