...
$cdate=$_GET['cdate'];
	...
	$hosname=$row_header['hosname'];
	    ...
	    $res_absent = mysql_query("SELECT department FROM employees	WHERE hosid ='$hosid'  and empname<>'' ORDER BY empname ASC LIMIT $start_from, 60");
