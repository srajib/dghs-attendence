...
<table width="1113px" align="center">
 ...
 <tr>
   <td width="322" valign="top"><div id="main" align="left" style="width:300px; background-color:#EEF5FD">
...
<td  height="33" colspan="2" valign="top">Date From 
   ...
   To
      ...
      <p>&nbsp;</p></td>
	  <td width="0" colspan="2"><script type="text/javascript">//<![CDATA[
      Calendar.setup({
        inputField : "f_date2",
        trigger    : "f_btn2",
        onSelect   : function() { this.hide() },
