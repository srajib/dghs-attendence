  ...
  <form method="post" action="" name="form1" id="form1">
    <table width="1000px" align="center">
      <tr>
        ...
        <td width="100"><input size="15" id="f_date1" name="f_date1" value="<?php echo @$_POST['f_date1'];?>" />
    ...
    //]]></script>        </td>
        ...
        <td width="100"><input size="15" id="f_date2" name="f_date2" value="<?php echo @$_POST['f_date2'];?>"/>
    ...
    //]]></script>        </td>
        <td width="40">Staff ID</td>
        <td width="50"><input name="empcode" type='text' id="empcode" value="<?php echo @$_POST['empcode'];?>" size="15"></td>
        <td width="30"><input name="submit" type="submit" value="Show Report" /> <input name="hosid" type='hidden' id="hosid" value="<?php echo @$_GET['hosid'];?>" size="15"> </td>
      </tr>
      <tr>
	...
	$weekfri = round(($weekday1 / 604800)+0.5);
	$weekday2 = strtotime("$date2",6) - strtotime("$date1",6);
	$weeksat = round(($weekday2 / 604800)+0.5);
...
<tr>
  <td width="302"><span class="style1"><font color="#0C75DE" size="+2">Staff Detail Report</font></span></td>
  <td width="276">&nbsp;</td>
  <td width="219">&nbsp;</td>
			...
			//echo mysql_num_rows(@$res_emp);
			 ...
			 mysql_query("insert into job_card(empcode,event_date,in_time,out_time,status,hosid,wkhour) values('$id','$evt_date','$entry','$outs','$status',$hosid,$timediff)");
			  ...
			  if($n%2==0)
				...
				$totalDayofwork_hour=($diff1-($Holy +$totalweekday )) * 8;
				$totalDayofwork=($diff1-($Holy +$totalweekday ));
