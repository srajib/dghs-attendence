...
<table width="1113px" align="center">
 ...
 <td  height="33" colspan="2">Date From 
   ...
   To
      ...
      <input name="submit" type="button" value="Show Report" onClick="showDiv();" /></td>
 ...
 <tr>
   ...
   <input type="hidden" name="divid" value="<?php echo $divid; ?>"></td>
 </tr>
 <tr>
...
<td width="900" valign="top"><div id="divid" align="left" style="width:900px"></div></td>
</tr>
	</table>	
</form>
</body>
