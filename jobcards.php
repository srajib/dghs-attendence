 ...
 <tr>
   <td><div id="main" style="width:300px; background-color:#EEF5FD">
	<ul id="navigation" style="border:double; border-color:#AFDBFE">
		<li style="background-color:#EEF5FD"><a href="#" style="text-decoration:none">Bangladesh</a>
			<ul>
<?php
    while($row = mysql_fetch_array($tree))
            {
                ?>
				<li style="background-color:#EEF5FD"><a href="#"style="text-decoration:none"><?php echo $row['divname']; ?></a>
					<ul>
                <?php
                $divid = $row['divid'];
               ...
               {  
                ?>
						<li style="background-color:#EEF5FD"><a href="#" style="text-decoration:none"><?php echo $rowdist['disname']; ?></a>
							...
							?>
                                <li style="background-color:#EEF5FD"><a href="#" style="text-decoration:none"><?php echo $rowupo['uponame']; ?></a>
									<ul>
									<?php 
									$upoid=$rowupo['upoid'];
									...
									?>
										<li style="background-color:#EEF5FD"><a href="job_card.php?hosid=<?php echo $rowhos['hosid'];?>" style="text-decoration:none"><?php echo $rowhos['hosname']; ?></a></li>
									<?php }?></ul>
								</li>
                               <?php }?> </ul>
               		  </li>
