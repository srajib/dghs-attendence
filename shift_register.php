...
<table width="1107" align="center">
 <tr>
   <td colspan="2"><?php echo '<a href="javascript:m.print()">Print</a>'; ?> | <?php echo '<a href="index.php">Home</a>'; ?>  </td>
 </tr>
 <tr>
									...
									$upoid=$rowupo['upoid'];
				           			$hos= mysql_query("SELECT * FROM hospitals WHERE upoid='$upoid'");
										while($rowhos = mysql_fetch_array($hos)){
																			?>
								<li style="background-color:#EEF5FD"><a href="shift_register.php?hosid=<?php echo $rowhos['hosid'];?>"><?php echo $rowhos['hosname']; ?></a></li>
									<?php }?></ul>
								</li>
                               <?php }?> </ul>
               		  </li>
...
Date From 
   ...
   To
      ...
      <button id="f_btn2">...</button>  Shift Name <select name="shiftid" id="shiftid"> <?php 
        ...
        <input name="submit" type="button" value="Execute" onClick="showhos();">
		<script type="text/javascript">//<![CDATA[
      Calendar.setup({
        inputField : "f_date2",
        trigger    : "f_btn2",
 ...
 <tr><td width="52"> <p>
      ...
      </p></td><td width="729" valign="top"><div id="hospitalid" valign="left" style="width:600px;border:dashed;border-color:#990000"></div></td></tr>
  <tr>   
    <td colspan="2">&nbsp;</td>
  </tr>
 </table>
